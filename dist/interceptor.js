...
var InterceptorManager = /*#__PURE__*/function () {
   ...
   */
  _proto.add = function add(resolved, rejected) {
    this._handlers.push({
      resolved: resolved,
      rejected: rejected
    });
...
var Interceptor = /*#__PURE__*/function () {
  ...
  var _proto2 = Interceptor.prototype;

  // 默认处理函数，直接返回参数
  _proto2.handle = function handle(params) {
    return Promise.resolve(params);
  } // 执行方法，按顺序执行before handle after
  ;

  _proto2.invoke = function invoke(params) {
    var chain = [].concat(this.interceptors.before._handlers, [{
...
//# sourceMappingURL=interceptor.map